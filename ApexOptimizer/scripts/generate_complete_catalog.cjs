...
const CATEGORY_META = [
  { id: '01_FIRST', num: '01', folder: '01 ПЕРВЫМ ДЕЛОМ', name: 'Первым делом', icon: 'ShieldAlert', accent: '#00f0ff', description: 'Создание точек восстановления, резервные копии реестра и сетевых адаптеров, аудит системы и Autoruns.' },
  ...
  { id: '04_GPU', num: '04', folder: '04 ВИДЕОКАРТА И ГРАФИКА', name: 'Видеокарта & Графика', icon: 'MonitorPlay', accent: '#10b981', description: 'Кастомный чистый драйвер 596.36, LLC-V2 Profile, DirectFlip Mode 2, DDU, NVCleanstall, Anomaly Fix и фикс MPO.' },
  { id: '05_POWER', num: '05', folder: '05 ПЛАНЫ ЭЛЕКТРОПИТАНИЯ', name: 'Планы электропитания', icon: 'Zap', accent: '#eab308', description: 'Эксклюзивный план Igromanoff AMD VIP (GUID 77777777...), Standart AMD, Intel V1-V3, LLC-CERTIFIED и PowerSettingsExplorer.' },
  ...
  { id: '07_NETWORK', num: '07', folder: '07 ИНТЕРНЕТ И СЕТЬ', name: 'Интернет & Сеть', icon: 'Wifi', accent: '#06b6d4', description: 'TCP NoDelay, NetworkThrottlingIndex ffffffff, тюнинг Realtek 2.5GbE, DnsJumper и фикс спайков Wi-Fi.' },
...
function generateWhatItDoes(filename) {
  const f = filename.toLowerCase();
