...
function writeFile(relPath, content) {
  ...
  // Ensure CRLF for Windows batch/reg files
  const crlfContent = content.replace(/\r?\n/g, '\r\n');
  fs.writeFileSync(fullPath, crlfContent, 'utf-8');
  console.log(`Created: ${relPath}`);
}

function copyFileIfExists(src, relDest) {
...
console.log('--- GENERATING ULTIMATE OPTIMIZATION PACK ---');

// ==========================================
// 00_BACKUP_AND_RESTORE_POINT
// ==========================================
writeFile('00_BACKUP_AND_RESTORE_POINT\\1_Create_System_Restore_Point.bat', `@echo off
:: ============================================================================
...
writeFile('00_BACKUP_AND_RESTORE_POINT\\2_Backup_Current_Registry.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 00. BACKUP & RESTORE POINT
...
writeFile('00_BACKUP_AND_RESTORE_POINT\\3_Backup_Network_Adapters.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 00. BACKUP & RESTORE POINT
...
writeFile('00_BACKUP_AND_RESTORE_POINT\\4_Backup_Power_Schemes.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 00. BACKUP & RESTORE POINT
...
// ==========================================
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\1_Disable_Telemetry_And_DiagTrack.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\2_Disable_Fast_Startup_And_Hibernation.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 01. WINDOWS BASE & DEBLOAT
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\3_Disable_UAC_Prompts.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\4_Disable_Background_Apps_Global.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\5_Disable_Windows_Error_Reporting.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\6_Disable_Cortana_And_Web_Search.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\7_Disable_Delivery_Optimization.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\8_Disable_Automatic_Maintenance.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\9_Remove_Windows_Bloatware_Apps.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 01. WINDOWS BASE & DEBLOAT
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\10_Restore_Classic_Context_Menu_Win11.reg', `Windows Registry Editor Version 5.00
...
writeFile('01_WINDOWS_BASE_AND_DEBLOAT\\REVERT_01_Base_Settings.reg', `Windows Registry Editor Version 5.00
...
// ==========================================
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\1_Win32PrioritySeparation_26_Hex1A_Esports.reg', `Windows Registry Editor Version 5.00
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\2_Win32PrioritySeparation_28_Hex1C_Foreground.reg', `Windows Registry Editor Version 5.00
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\3_Win32PrioritySeparation_18_Hex12_Balanced.reg', `Windows Registry Editor Version 5.00
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\4_BCD_Disable_Dynamic_Tick.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\5_BCD_Use_Platform_Tick.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\6_BCD_Delete_HPET_Platform_Clock.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\7_BCD_TSCSyncPolicy_Enhanced.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\8_BCD_Disable_Boot_UX_And_QuietBoot.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\9_BCD_Hypervisor_Launch_Type_Off.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\10_Unpark_All_CPU_Cores.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\11_AMD_Ryzen_3D_VCache_Optimizer.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\12_Intel_Hybrid_E_Core_Policy.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 02. CPU SCHEDULING & TIMERS
...
writeFile('02_CPU_SCHEDULING_AND_TIMERS\\REVERT_02_CPU_And_Timers.bat', `@echo off
:: ============================================================================
...
// ==========================================
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\1_Enable_HAGS_Hardware_GPU_Scheduling.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\2_Disable_MPO_Multiplane_Overlay_Fix.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\3_Disable_GameDVR_And_Xbox_Capture.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\4_Enable_FSE_And_FSO_Optimizations.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\5_Set_DirectX_DXGKrnl_Thread_Priority.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\6_Set_Nvidia_Kernel_nvlddmkm_Thread_Priority.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\7_Nvidia_Profile_Inspector_LLC_Esports_Import.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 03. GPU & GRAPHICS LATENCY
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\8_Nvidia_Profile_Inspector_UltraLowLatency_Import.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 03. GPU & GRAPHICS LATENCY
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\9_Disable_GPU_Energy_Throttling.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\10_Enable_Variable_Refresh_Rate_VRR.reg', `Windows Registry Editor Version 5.00
...
writeFile('03_GPU_AND_GRAPHICS_LATENCY\\REVERT_03_GPU_Settings.reg', `Windows Registry Editor Version 5.00
...
// ==========================================
writeFile('04_MEMORY_AND_STORAGE_SPEED\\1_Pin_Kernel_In_RAM_DisablePagingExecutive.reg', `Windows Registry Editor Version 5.00
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\2_Disable_Memory_Compression.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 04. MEMORY & STORAGE SPEED
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\3_Disable_Page_Combining_And_Prelaunch.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 04. MEMORY & STORAGE SPEED
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\4_Disable_NVMe_SATA_StorPort_Idle.reg', `Windows Registry Editor Version 5.00
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\5_Disable_NTFS_8dot3_Name_Creation.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 04. MEMORY & STORAGE SPEED
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\6_Disable_NTFS_Last_Access_Update.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 04. MEMORY & STORAGE SPEED
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\7_Increase_NTFS_Memory_Usage_Buffer.reg', `Windows Registry Editor Version 5.00
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\8_Enable_TRIM_Optimization.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 04. MEMORY & STORAGE SPEED
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\9_Set_System_Responsiveness_Zero.reg', `Windows Registry Editor Version 5.00
...
writeFile('04_MEMORY_AND_STORAGE_SPEED\\REVERT_04_Memory_And_Storage.reg', `Windows Registry Editor Version 5.00
...
// ==========================================
writeFile('05_ETHERNET_AND_NETWORK_PING\\1_Disable_Nagle_Algorithm_TCPNoDelay.reg', `Windows Registry Editor Version 5.00
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\2_Enable_TcpAckFrequency_1_Instant_Packets.reg', `Windows Registry Editor Version 5.00
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\3_Disable_Network_Throttling_Index.reg', `Windows Registry Editor Version 5.00
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\4_Netsh_TCP_Autotuning_Normal_CTCP.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 05. ETHERNET & NETWORK PING
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\5_Optimize_DNS_And_NetBT_Priorities.reg', `Windows Registry Editor Version 5.00
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\6_Network_Adapter_Disable_PowerSaving.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 05. ETHERNET & NETWORK PING
...
foreach ($adapter in $adapters) {
    ...
    # Disable Flow Control to avoid queue pauses
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\7_Network_Adapter_Esports_Offloads_Tuning.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 05. ETHERNET & NETWORK PING
...
foreach ($adapter in $adapters) {
    ...
    # Disable Large Send Offload (LSO) for lower jitter and packet pacing
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\8_Set_MaxUserPort_And_TcpTimedWaitDelay.reg', `Windows Registry Editor Version 5.00
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\9_Flush_DNS_ARP_And_Reset_Winsock.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 05. ETHERNET & NETWORK PING
...
writeFile('05_ETHERNET_AND_NETWORK_PING\\REVERT_05_Network_Settings.reg', `Windows Registry Editor Version 5.00
...
// ==========================================
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\1_MarkC_Windows11_10_Mouse_Fix_100_Percent.reg', `Windows Registry Editor Version 5.00
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\2_Set_MouseDataQueueSize_16_Low_Buffer.reg', `Windows Registry Editor Version 5.00
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\3_Set_KeyboardDataQueueSize_16_Low_Buffer.reg', `Windows Registry Editor Version 5.00
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\4_Apply_Competitive_FilterKeys_0ms_15ms.reg', `Windows Registry Editor Version 5.00
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\5_Disable_USB_Selective_Suspend_Global.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 06. MOUSE & KEYBOARD INPUT LAG
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\6_Set_USBHUB3_USBXHCI_Thread_Priority.reg', `Windows Registry Editor Version 5.00
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\7_Disable_Mouse_Acceleration_And_Thresholds.reg', `Windows Registry Editor Version 5.00
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\8_HIDUSBF_Mouse_Overclocking_Guide_RU.txt', `================================================================================
...
writeFile('06_MOUSE_KEYBOARD_INPUT_LAG\\REVERT_06_Input_Devices.reg', `Windows Registry Editor Version 5.00
...
// ==========================================
writeFile('07_AUDIO_AND_MMCSS_OPTIMIZATION\\1_Configure_MMCSS_Games_High_Priority.reg', `Windows Registry Editor Version 5.00
...
writeFile('07_AUDIO_AND_MMCSS_OPTIMIZATION\\2_Configure_MMCSS_Audio_Zero_Stutter.reg', `Windows Registry Editor Version 5.00
...
writeFile('07_AUDIO_AND_MMCSS_OPTIMIZATION\\3_Disable_Spatial_Sound_Overhead.reg', `Windows Registry Editor Version 5.00
...
writeFile('07_AUDIO_AND_MMCSS_OPTIMIZATION\\4_Set_Audio_DPC_Latency_Tolerance.reg', `Windows Registry Editor Version 5.00
...
writeFile('07_AUDIO_AND_MMCSS_OPTIMIZATION\\5_Fix_MMCSS_Network_Bandwidth_Throttling.reg', `Windows Registry Editor Version 5.00
...
writeFile('07_AUDIO_AND_MMCSS_OPTIMIZATION\\REVERT_07_Audio_And_MMCSS.reg', `Windows Registry Editor Version 5.00
...
// ==========================================
writeFile('08_POWER_PLANS_AND_ENERGY\\1_Import_And_Activate_LLC_Certified_Plan.bat', `@echo off
:: ============================================================================
...
writeFile('08_POWER_PLANS_AND_ENERGY\\2_Import_And_Activate_Ultimate_Performance.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 08. POWER PLANS & ENERGY
...
writeFile('08_POWER_PLANS_AND_ENERGY\\3_Import_And_Activate_AMD_3D_VCache_Plan.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 08. POWER PLANS & ENERGY
...
writeFile('08_POWER_PLANS_AND_ENERGY\\4_Import_And_Activate_Intel_High_Perf_Plan.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 08. POWER PLANS & ENERGY
...
writeFile('08_POWER_PLANS_AND_ENERGY\\5_Disable_PCIe_ASPM_Link_State_Power.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 08. POWER PLANS & ENERGY
...
writeFile('08_POWER_PLANS_AND_ENERGY\\6_Set_EPP_Energy_Performance_Preference_Zero.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 08. POWER PLANS & ENERGY
...
writeFile('08_POWER_PLANS_AND_ENERGY\\REVERT_08_Restore_Balanced_Plan.bat', `@echo off
:: ============================================================================
...
// ==========================================
writeFile('09_SERVICES_AND_BACKGROUND_TASKS\\1_Apply_Safe_Gaming_Services_Config.bat', `@echo off
:: ============================================================================
...
writeFile('09_SERVICES_AND_BACKGROUND_TASKS\\2_Apply_Esports_Competitive_Services_Config.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 09. SERVICES & BACKGROUND TASKS
...
writeFile('09_SERVICES_AND_BACKGROUND_TASKS\\3_Disable_100_Telemetry_Scheduled_Tasks.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 09. SERVICES & BACKGROUND TASKS
...
writeFile('09_SERVICES_AND_BACKGROUND_TASKS\\4_Clean_Driver_Store_Duplicate_OEM_Drivers.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 09. SERVICES & BACKGROUND TASKS
...
writeFile('09_SERVICES_AND_BACKGROUND_TASKS\\5_Disable_Windows_Search_Indexing.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 09. SERVICES & BACKGROUND TASKS
...
writeFile('09_SERVICES_AND_BACKGROUND_TASKS\\REVERT_09_Restore_Default_Services.bat', `@echo off
:: ============================================================================
...
// ==========================================
writeFile('10_MSI_AND_INTERRUPT_AFFINITY\\1_Enable_MSI_Mode_For_GPU_High_Priority.ps1', `# ============================================================================
...
foreach ($gpu in $gpus) {
    ...
    Set-ItemProperty -Path $affPath -Name "DevicePriority" -Value 3 -Type DWord -Force # High Priority
...
writeFile('10_MSI_AND_INTERRUPT_AFFINITY\\2_Enable_MSI_Mode_For_NIC_Ethernet.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 10. MSI & INTERRUPT AFFINITY
...
writeFile('10_MSI_AND_INTERRUPT_AFFINITY\\3_Enable_MSI_Mode_For_USB_Controllers.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 10. MSI & INTERRUPT AFFINITY
...
writeFile('10_MSI_AND_INTERRUPT_AFFINITY\\4_Enable_MSI_Mode_For_NVMe_Storage.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 10. MSI & INTERRUPT AFFINITY
...
writeFile('10_MSI_AND_INTERRUPT_AFFINITY\\5_Device_Tweaker_PCI_IRQ_Balancing_Script.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 10. MSI & INTERRUPT AFFINITY
...
writeFile('10_MSI_AND_INTERRUPT_AFFINITY\\6_Affinity_Isolate_GPU_Interrupts_Core2.ps1', `# ============================================================================
# ULTIMATE OPTIMIZATION PACK - 10. MSI & INTERRUPT AFFINITY
...
foreach ($gpu in $gpus) {
    ...
    Set-ItemProperty -Path $affPath -Name "DevicePolicy" -Value 4 -Type DWord -Force # Specified Processors
    Set-ItemProperty -Path $affPath -Name "AssignmentSetOverride" -Value ([byte[]](0x04, 0x00, 0x00, 0x00)) -Type Binary -Force # Core 2 Mask
...
writeFile('10_MSI_AND_INTERRUPT_AFFINITY\\REVERT_10_Reset_MSI_And_Affinity.ps1', `# ============================================================================
...
// ==========================================
writeFile('11_GAMES_CS2_VALORANT_APEX_CONFIGS\\1_CS2_Ultimate_Zero_Latency_Autoexec.cfg', `// ================================================================
...
writeFile('11_GAMES_CS2_VALORANT_APEX_CONFIGS\\2_CS2_IFEO_High_CPU_And_IO_Priority.reg', `Windows Registry Editor Version 5.00
...
writeFile('11_GAMES_CS2_VALORANT_APEX_CONFIGS\\3_Valorant_Riot_Vanguard_Optimal_Settings.txt', `================================================================================
...
writeFile('11_GAMES_CS2_VALORANT_APEX_CONFIGS\\4_Apex_Legends_Autoexec_High_FPS.cfg', `// ================================================================
...
writeFile('11_GAMES_CS2_VALORANT_APEX_CONFIGS\\REVERT_11_Remove_Game_IFEO_And_Configs.bat', `@echo off
:: ============================================================================
...
// ==========================================
writeFile('12_REVERT_ALL_TWEAKS_RESTORE\\RESTORE_ALL_DEFAULT_WINDOWS_SETTINGS.bat', `@echo off
:: ============================================================================
...
writeFile('12_REVERT_ALL_TWEAKS_RESTORE\\RESTORE_REGISTRY_AND_SERVICES.ps1', `# ============================================================================
...
// ==========================================
writeFile('13_DIAGNOSTICS_LATENCY_TOOLS\\1_Run_LatencyMon_DPC_Diagnostic.bat', `@echo off
:: ============================================================================
...
writeFile('13_DIAGNOSTICS_LATENCY_TOOLS\\2_Check_Current_Timer_Resolution.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 13. DIAGNOSTICS & BENCHMARKS
...
writeFile('13_DIAGNOSTICS_LATENCY_TOOLS\\3_Check_PCI_MSI_Mode_Status.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 13. DIAGNOSTICS & BENCHMARKS
...
writeFile('13_DIAGNOSTICS_LATENCY_TOOLS\\4_Benchmark_System_Responsiveness.bat', `@echo off
:: ============================================================================
:: ULTIMATE OPTIMIZATION PACK - 13. DIAGNOSTICS & BENCHMARKS
...
// ==========================================
writeFile('Quick_Apply_Safe_Gaming.bat', `@echo off
chcp 65001 >nul
...
writeFile('Quick_Apply_Esports_Maximum.bat', `@echo off
chcp 65001 >nul
...
:: 2. Windows Base Debloat
echo [*] [2/13] Applying Windows Base Debloat & Telemetry Purge...
regedit /s "%PACK_DIR%01_WINDOWS_BASE_AND_DEBLOAT\\1_Disable_Telemetry_And_DiagTrack.reg"
...
:: 3. CPU Scheduling, Timers & Core Unparking
echo [*] [3/13] Configuring CPU Scheduling, Enhanced TSC Sync & Core Unparking...
regedit /s "%PACK_DIR%02_CPU_SCHEDULING_AND_TIMERS\\1_Win32PrioritySeparation_26_Hex1A_Esports.reg"
...
:: 4. GPU Latency, HAGS, DirectFlip & Driver Optimization
echo [*] [4/13] Calibrating GPU Drivers, HAGS, DirectFlip & Thread Priorities...
regedit /s "%PACK_DIR%03_GPU_AND_GRAPHICS_LATENCY\\1_Enable_HAGS_Hardware_GPU_Scheduling.reg"
regedit /s "%PACK_DIR%03_GPU_AND_GRAPHICS_LATENCY\\2_Disable_MPO_Multiplane_Overlay_Fix.reg"
regedit /s "%PACK_DIR%03_GPU_AND_GRAPHICS_LATENCY\\3_Disable_GameDVR_And_Xbox_Capture.reg"
...
:: 5. Memory & Storage
echo [*] [5/13] Optimizing Memory Paging, NTFS Filesystem & StorPort Low-Latency...
regedit /s "%PACK_DIR%04_MEMORY_AND_STORAGE_SPEED\\1_Pin_Kernel_In_RAM_DisablePagingExecutive.reg"
regedit /s "%PACK_DIR%04_MEMORY_AND_STORAGE_SPEED\\3_Disable_NVMe_SATA_StorPort_Idle.reg"
...
echo  [+] Memory & Storage latency optimizations deployed.

:: 6. Network & Ethernet
echo [*] [6/13] Configuring TCP/IP Zero-Delay Stack & Network Adapter...
regedit /s "%PACK_DIR%05_ETHERNET_AND_NETWORK_PING\\1_Disable_Nagle_Algorithm_TCPNoDelay.reg"
...
:: 7. Mouse & Keyboard Input Stack
echo [*] [7/13] Applying 1:1 Mouse Linear Mapping, 16 Packet Buffer & FilterKeys...
regedit /s "%PACK_DIR%06_MOUSE_KEYBOARD_INPUT_LAG\\1_MarkC_Windows11_10_Mouse_Fix_100_Percent.reg"
...
:: 8. Audio Isolation & MMCSS High Priority
echo [*] [8/13] Configuring MMCSS Gaming Priority & AudioDG Low-Latency Isolation...
regedit /s "%PACK_DIR%07_AUDIO_AND_MMCSS_OPTIMIZATION\\1_Configure_MMCSS_Games_High_Priority.reg"
...
:: 9. Power Plans & Energy Management
echo [*] [9/13] Activating Esports Low-Latency Power Plan...
set POW_FILE="%PACK_DIR%08_POWER_PLANS_AND_ENERGY\\LLC-CERTIFIED.pow"
if exist %POW_FILE% (
    powercfg -import %POW_FILE% 33333333-3333-3333-3333-333333333333 >nul 2>&1
...
:: 10. Background Services & Telemetry Scheduled Tasks
echo [*] [10/13] Disabling Bloat Services & Telemetry Scheduled Tasks...
...
:: 11. MSI Mode & Hardware Interrupt Steering
echo [*] [11/13] Enabling MSI Mode & High Priority for GPU, NIC & Storage...
...
:: 13. Classic UI, Fast Menu & System Cache Flush
echo [*] [13/13] Restoring Classic Context Menu, Fast Menu Delay & Flushing Caches...
...
arp -d * >nul 2>&1
echo  [+] UI animations accelerated, DNS & ARP caches refreshed.
...
echo  - 100%% CPU Core Unparking & EPP 0 Boost active
echo  - DirectFlip Mode 2 & HAGS Low Display Latency active
echo  - 1:1 Linear Mouse HID 16 Queue Buffer active
echo  - TCP NoDelay & Network Throttling removed
echo  - Background Telemetry & 100+ Scheduled Tasks Purged
echo.
...
writeFile('Quick_Revert_To_Default.bat', `@echo off
:: ============================================================================
...
writeFile('Launch_ApexOptimizer_GUI.bat', `@echo off
:: ============================================================================
...
// ==========================================
writeFile('README_FULL_GUIDE_RU.md', `# ИДЕАЛЬНЫЙ ПАК ОПТИМИЗАЦИИ WINDOWS 10 / 11 (1000+ ГАЙДОВ)
...
writeFile('README_FULL_GUIDE_EN.md', `# ULTIMATE WINDOWS 10 / 11 OPTIMIZATION PACK (1000+ GUIDES)
...
// Copy essential binary assets if present in workspace
copyFileIfExists('d:\\winvan\\ApexOptimizer\\bin\\PowerRun_x64.exe', 'bin\\PowerRun_x64.exe');
copyFileIfExists('d:\\winvan\\LLC Pack\\10. Службы-И-Драйверы\\PowerRun_x64.exe', 'bin\\PowerRun_x64.exe');
copyFileIfExists('d:\\winvan\\ApexOptimizer\\bin\\nvidiaProfileInspector.exe', 'bin\\nvidiaProfileInspector.exe');
copyFileIfExists('d:\\winvan\\LLC Pack\\2. Драйверы\\2. Видеокарта\\Nvidia Profile Inspector\\nvidiaProfileInspector.exe', 'bin\\nvidiaProfileInspector.exe');
copyFileIfExists('d:\\winvan\\ApexOptimizer\\bin\\LLC-OPTIMIZED-V2.nip', 'bin\\LLC-OPTIMIZED-V2.nip');
copyFileIfExists('d:\\winvan\\LLC Pack\\2. Драйверы\\2. Видеокарта\\Nvidia Profile Inspector\\LLC-OPTIMIZED-V2.nip', 'bin\\LLC-OPTIMIZED-V2.nip');
copyFileIfExists('d:\\winvan\\LLC Pack\\4. План-питания\\LLC-CERTIFIED.pow', '08_POWER_PLANS_AND_ENERGY\\LLC-CERTIFIED.pow');
copyFileIfExists('d:\\winvan\\Igromanoff AMD Power Pack\\1 - AMD\\1 - AMD.pow', '08_POWER_PLANS_AND_ENERGY\\1 - AMD.pow');
copyFileIfExists('d:\\winvan\\Igromanoff AMD Power Pack\\2 - INTEL\\2 - INTEL.pow', '08_POWER_PLANS_AND_ENERGY\\2 - INTEL.pow');
copyFileIfExists('d:\\winvan\\LLC Pack\\3. CRU\\CRU.exe', '13_DIAGNOSTICS_LATENCY_TOOLS\\CRU.exe');

console.log('--- ULTIMATE OPTIMIZATION PACK GENERATION COMPLETE ---');
